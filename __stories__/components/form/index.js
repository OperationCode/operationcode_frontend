...
class SimpleForm extends React.Component {
  ...
  render() {
    return (
      <Form>
        <FormInput id="firstName" label="First Name" onChange={this.handleFirstNameChange} />
        <FormInput id="lastName" label="Last Name" onChange={this.handleLastNameChange} />
...
storiesOf('shared/components/form', module).add('Simple form', () => <SimpleForm />);
