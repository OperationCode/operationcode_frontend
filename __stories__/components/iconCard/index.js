...
storiesOf('shared/components/iconCard', module)
  .add('Default', () => <IconCard title="Title" fontAwesomeIcon="FaRoad" />)
  .add('With subText', () => (
    <IconCard
      title="Title"
  ...
  .add('Sized icon', () => <IconCard title="Title" fontAwesomeIcon="FaStar" iconSize="200" />)
  .add('Icon above heading', () => (
    <IconCard title="Title" fontAwesomeIcon="FaThumbsUp" iconAboveHeading />
  ))
