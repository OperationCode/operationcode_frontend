      ...
      <div className={styles.timeline}>
        ...
        <div className={styles.segment}>
          ...
          <div className={styles.timelineEvent}>
            ...
            <TimelineEvent
              title="First Donor"
              content={['Web developer, teacher, entrepreneur and co-founder of ', <a href="https://www.codefellows.org" target="_blank" rel="noopener noreferrer">Code Fellows</a>, ', Ivan Storck, purchases the domain \'', <a href="https://operationcode.org" target="_blank" rel="noopener noreferrer">operationcode.org</a>, '\' becoming our first donor in the process.']}
            />
            <TimelineEvent
              title="DNSimple Joins The Operation"
              content={[<a href="https://dnsimple.com" target="_blank" rel="noopener noreferrer"> DNSimple</a>, ' joined Operation Code as the sole domain management service provider, ensuring maximum uptime.']}
            />
            <TimelineEvent
              title="Charles Sipe's Article"
              content={['Army veteran and aspiring software developer, Charles Sipe, writes a viral, Veteran\'s Day article called ', <a href="https://www.switchup.org/blog/why-veterans-will-make-excellent-programmers" target="_blank" rel="noopener noreferrer">&apos;Why Will Make Excellent Programmers&apos;</a>, '.']}
            />
            <TimelineEvent
              title="HackHands Co-Founders And The Logo"
              content={['HackHands co-founders, Forest Good and Geraldo Ramos, join Operation Code, designing our logo and providing veterans free access to ', <a href="https://hacksummit.org" target="_blank" rel="noopener noreferrer">hack.summit()</a>, ' a virtual conference to learn from the world\'s most renowned programmers.']}
            />
          </div>
        </div>
        ...
        <div className={styles.segment}>
          ...
          <div className={styles.timelineEvent}>
            ...
            <TimelineEvent
              title="Ruby On Ales"
              content={[<a href="https://ruby.onales.com" target="_blank" rel="noopener noreferrer">Ruby on Ales</a>, ' - located in Bend, Oregon - becomes the first software developer industry conference to support veterans with Ruby development classes.']}
            />
            <TimelineEvent
            ...
            <TimelineEvent
              ...
              content={['Operation Code changes it\'s Twitter handle to ', <a href="https://twitter.com/operation_code" target="_blank" rel="noopener noreferrer"> @operation_code</a>, ' for more effective branding. ', <a href="https://instagram.com/operation_code" target="_blank" rel="noopener noreferrer"> Instagram</a>, ' and ', <a href="https://facebook.com/operationcode.org" target="_blank" rel="noopener noreferrer"> Facebook</a>, ' accounts are created.']}
            />
            <TimelineEvent
              title="Launch Party"
              content={[<a href="https://calagator.org/events/1250468219" target="_blank" rel="noopener noreferrer">Formal launch of Operation Code</a>, '. The event hosts dozens of veterans, software developers, media representatives, and staff members from U.S. Senator Ron Wyden and Congressman Blumenauer\'s offices.']}
            />
            <TimelineEvent
            ...
            <TimelineEvent
              ...
              content={['Fernando Paredes, Nell Shamrell, and Eric McKenna improve Operation Code\'s participation in open source development with our first ', <a href="https://github.com/OperationCode/operationcode/blob/master/CONTRIBUTING.md" target="_blank" rel="noopener noreferrer">contributing guide</a>, '.']}
            />
            <TimelineEvent
              title="AirBnB Sponsorship"
              content={['Global hospitality provider, ', <a href="https://www.airbnb.com/" target="_blank" rel="noopener noreferrer">Airbnb</a>, ' sponsors lodging for Operation Code members attending SignalConf in San Francisco. ', <a href="https://www.instagram.com/p/21p5bFxUjd/?taken-by=davidcmolina" target="_blank" rel="noopener noreferrer">They also invited our members to tour their headquarters</a>, '! Airbnb forges their partnership with Operation Code in steel by offering sponsored lodgings for veterans interviewing for a career in tech.']}
            />
            <TimelineEvent
              title="SignalConf Sponsorship"
              content={[<a href="https://www.twilio.com/signal/2015" target="_blank" rel="noopener noreferrer">SignalConf</a>, ' provides multiple Operation Code members with sponsored tickets. ', <a href="https://www.twilio.com/" target="_blank" rel="noopener noreferrer">Twilio</a>, ' - the conference\'s main sponsor - hosts an insightful tour of their headquarters.']}
            />
            <TimelineEvent
            ...
            <TimelineEvent
              ...
              content={['To meet growth demands, Operation Code ', <a href="https://twitter.com/operation_code/status/614443994769027072" target="_blank" rel="noopener noreferrer">separates from its financial supporter</a>, '. The Cogostar Foundation - Operation Code\'s current sponsor - helps to reorganize a new governing Board of Directors, comprised of Josh Carter, Aimee Knight, Nick Frost, Pete Runyon, Laura Gómez, Fernando Paredes, and Elmer Thomas. Operation Code incorporates as an Oregon non-profit organization.']}
            />
            <TimelineEvent
              title="Stickers Distributed"
              content={[<a href="https://www.stickermule.com/" target="_blank" rel="noopener noreferrer"> Sticker Mule</a>, ' provides free stickers to all members! Laptops around the nation equip our logo.']}
            />
            <TimelineEvent
        ...
        <div className={styles.segment}>
          ...
          <div className={styles.timelineEvent}>
            <TimelineEvent
              title="Hack Summit"
              content={[<a href="https://hacksummit.org/" target="_blank" rel="noopener noreferrer">hack.summit()</a>, ' adds Operation Code to its list of coding non-profits.']}
            />
            <TimelineEvent
              title="Speakeasy"
              content={[<a href="https://speakeasy.co/" target="_blank" rel="noopener noreferrer">Speakeasy</a>, ' joins as the Operation Code conference sponsor.']}
            />
            <TimelineEvent
        ...
        <div className={styles.segment}>
          ...
          <div className={styles.timelineEvent}>
            ...
            <TimelineEvent
              ...
              content={['On Independence Day, the ', <a href="https://twitter.com/operation_code/status/882280600920616960" target="_blank" rel="noopener noreferrer">2000th Operation Code member joined our Slack Team</a>, '.']}
            />
          </div>
        </div>
      </div>
