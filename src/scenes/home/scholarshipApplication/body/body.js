...
class Body extends Component {
  ...
  handleOnClick = (e) => {
    ...
    postBackend('scholarship_applications', body)
      .then(() => {
  ...
  isValid = () => this.state.terms_accepted && this.state.reasonValid;
    ...
    return (
      <div>
        ...
        <FormCheckBox
          ...
          checkBox={{ display: 'block', margin: '20px 0px 20px 5px' }}
        ...
        {this.isValid() ? (
          ...
          <FormButton className={styles.grey_button} text="Submit Application" disabled />
        )}
