...
const BrandingLogo = () => (
  <Section title="Logo">
    ...
    <p>
      <a href="https://ocbranding.squarespace.com/s/Operation-Code-Logo.eps">Download master EPS file</a>
    </p>
    <p className={styles.logosInfo}>
      The files below are transparent PNGs.
      Click-and-drag (or for mobile, press-and-hold) them directly from your
