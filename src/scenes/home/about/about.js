  ...
  <div>
    ...
    <Section title="About" theme="white">
      ...
      <p>
        ...
        continuing to expand our offerings as often as possible. First and foremost,{' '}
        <Link to="/team">our staff</Link> works tirelessly to provide mentorship for veterans
        interested in learning about various tech careers. Dozens of software engineers, product
        managers, system architects, security engineers, and various other IT professionals act as
        1-on-1 mentors to all of our members. We also have a hardware loan program to help veterans
        in need of a laptop!
      </p>
      <p>
        As a non-profit organization, we rely heavily on your support. If you are interested in
        helping us financially, please{' '}
        <a
        ...
        or{' '}
        <a href="https://smile.amazon.com/ch/47-4247572" target="_blank" rel="noopener noreferrer">
          set your Amazon Smile organization to &quot;Operation Code&quot;
        </a>. If you have questions about our organization, platforms, or services, please reference
        our <Link to="/faq">FAQ page</Link>. Otherwise, do not hesitate to{' '}
    ...
    <Section title="Who We Serve" theme="white">
      <p className={styles.sectionParagraph}>
        Past and present Army, Navy, Marines, Air Force, and Coast Guard service members, veterans,
        military spouses, and family members are welcome to apply to any of our programs. Through
        our online community, we work with 2000+ members around the world.
      </p>
      <br />
