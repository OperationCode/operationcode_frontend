  ...
  <div>
    <div className={styles.banner}>
      <h2 className={styles.bannerText}>
        A non-profit charity helping the military community learn software
    ...
    <Section title="About" theme="white">
      <p>
        We at Operation Code strive to provide an efficient way into a tech
        career for veterans and their families. We work directly with Senators,
        Congressmen, and Congresswomen to allow veterans total control of their
        future by permitting the use of the GI Bill on coding bootcamps. You can
        read about our organization&apos;s history{' '}
        <Link to="/history">here</Link>.
      </p>
      <p>
        Aside from our work on the Hill, we offer many services to the military
        community and are continuing to expand our offerings as often as
        possible. First and foremost, <Link to="/team">our staff</Link> works
        tirelessly to provide mentorship for veterans interested in learning
        about various tech careers. Dozens of software engineers, product
        managers, system architects, security engineers, and various other IT
        professionals act as 1-on-1 mentors to all of our members. We also have
        a hardware loan program to help veterans in need of a laptop!
      </p>
      <p>
        As a non-profit organization, we rely heavily on your support. If you
        are interested in helping us financially, please{' '}
        <a
        ...
        <a
          ...
          rel="noopener noreferrer"
        >
          set your Amazon Smile organization to &quot;Operation Code&quot;
        </a>. If you have questions about our organization, platforms, or
        services, please reference our <Link to="/faq">FAQ page</Link>.
        Otherwise, do not hesitate to{' '}
        <Link to="/contact">reach out to our staff</Link>.
      </p>
    </Section>
    ...
    <Section title="Mission">
      <p className={styles.sectionParagraph}>
        Operation Code is leading the way to expand opportunities for military
        veterans and their families. We aim to help veterans learn new skills
        and build their careers in the fast-growing technology sector. Our
        team’s mission - led by veterans and other dedicated, passionate
        volunteers - is to help open doors for our diverse member base through
        unique program offerings, such as our Software Mentor Program,
        conference scholarships, and employment services. All of this is made
        possible by individual donations and corporate partnerships.
      </p>
    </Section>
