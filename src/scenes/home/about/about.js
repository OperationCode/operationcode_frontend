      ...
      <div>
        <Section title="Mission" theme="white">
          <p className={styles.sectionParagraph}>
            ...
            Through teaching veterans, transitioning servicemembers, and their families to code with open source projects, we'll be able to help fill our economy's technical talent shortage with our nation's finest.
            We aim to help veterans learn new skills and build their careers in the fast-growing technology sector.
            Our team’s mission - led by veterans and other dedicated, passionate volunteers - is to help open doors for the diverse military community through our mentorship, career development, and scholarship programs.
