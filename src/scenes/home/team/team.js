      ...
      <div>
        ...
        <Section title="Our Board" theme="white">
          <div className={styles.board}>
            ...
            Elmer Thomas is a developer experience engineer at Sendgrid, and his life goal is to create a positive impact for the greatest number of people over the longest period of time. Elmer is a former United States Marine and a founding board member of Operation Code.
            ...
            Dr. Stacy Chin is the CEO and co-founder of Hydroglyde Coatings, and has a Ph.D in Chemistry from Boston University. Dr. Chin is an entrepreneur, mentor, and active tutor in graduate sciences. She champions the interests of women in science, technology, engineering and mathematics.
