        ...
        <Section title="Operation Code Challenge" theme="white" className={styles.displayBlock}>
          ...
          <ol className={styles.instructionList}>
            ...
            <li>
              ...
              <a href={RepoLink} target="_blank" rel="noopener noreferrer">this link</a> and
              click on this button near the top-right corner of the screen:&nbsp;
            ...
            <li>
              ...
              necessary file to add your name to the list below! Inside the <code>/src</code> folder
            ...
            <li>
              ...
              <br /><br />
              <img src={ExampleImage} alt="example of GitHub input thus far" className={styles.blockImage} />
              <br /><br />
            ...
            <li>
              ...
              to ask ourselves for permission to merge our new branch into our own fork! Instead,&nbsp;
              click <a href={`${RepoLink}compare`} target="_blank" rel="noopener noreferrer">here</a>
              , to open Operation Code&apos;s &quot;New pull request&quot; interface. You should see
              a &quot;Compare changes&quot; headline. Just below that is a link within the text:&nbsp;
              &apos;compare across forks&apos; - click it. Now, click on the selector that says &apos;
              head fork&apos; at the beginning, and choose your fork. Click the next selector to the
              right, and choose your new branch. Now, you&apos;re comparing Operation Code&apos;s
              master branch with your new fork&apos;s branch, and you may click
            ...
            <blockquote>
              <i><u>NOTE:</u></i> A pull request is how people throughout the world are able to
              contribute to open source software - like Operation Code&apos;s website! When you
              submit a pull request it notifies the maintainers of the project, and runs some
              automated checks. The maintainers then look at the new changes, and decide if they
              want it merged into their repository.
            </blockquote>
            <br />
