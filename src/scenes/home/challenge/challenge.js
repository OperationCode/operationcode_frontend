      ...
      <div>
        <Section title="Operation Code Challenge" theme="white" className={styles.displayBlock}>
          ...
          <p>
            ...
            The source code for this website lives here: <a href="https://github.com/OperationCode/operationcode_frontend">https://github.com/OperationCode/operationcode_frontend</a><br />
            Visit this link and click on the <code>Fork</code> button in the top right corner.<br />
            You should see a message like &apos;Forking OperationCode/operationcode_frontend&apos; and in a few moments be redirected to a URL like: <a href="">https://github.com/&lt;YOUR_USERNAME&gt;/operationcode_frontend</a><br />
