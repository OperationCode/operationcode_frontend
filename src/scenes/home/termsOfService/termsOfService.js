...
const Terms = () => (
  <Section title="Terms of Service" theme="white">
    ...
    <p>
      ...
      before using the https:&#8725;&#8725;www.operationcode.org&#8725; website (the
      &#34;Service&#34;) operated by Operation Code (&#34;us&#34;, &#34;we&#34;, or &#34;our&#34;).
    </p>
    <p>
    ...
    <p>
      ...
      is yours (you own it) and&#8725;or you have the right to use it and the right to grant us the
      ...
      contract rights or any other rights of any person or entity. We reserve the right to terminate
    ...
    <p>
      ...
      However, by posting Content using the Service you grant us the right and license to use,
    ...
    <p>
      Operation Code has the right but not the obligation to monitor and edit all Content provided
      by users.
    </p>
    <p>
      In addition, Content found on or through this Service are the property of Operation Code or
      used with permission. You may not distribute, modify, transmit, reuse, download, repost, copy,
      or use said Content, whether in whole or in part, for commercial purposes or for personal
    ...
    <p>
      ...
      functionality are and will remain the exclusive property of Operation Code and its licensors.
      ...
      product or service without the prior written consent of Operation Code.
    </p>
    ...
    <p>
      Operation Code has no control over, and assumes no responsibility for the content, privacy
    ...
    <p>
      You acknowledge and agree that Operation Code shall not be responsible or liable, directly or
    ...
    <p>
      ...
      use and access of the Service, by you or any person using your account and password; b) a
      breach of these Terms, or c) Content posted on the Service.
    </p>
    <h3>Limitation Of Liability</h3>
    <p>
      In no event shall Operation Code, nor its directors, employees, partners, agents, suppliers,
    ...
    <p>
      Operation Code its subsidiaries, affiliates, and its licensors do not warrant that a) the
    ...
    <h3>Governing Law</h3>
    <p>
      These Terms shall be governed and construed in accordance with the laws of Oregon, United
